...
import { Plus, Search, FileText, X, FileSpreadsheet, Printer, Trash2, Edit } from "lucide-react";
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-[#fdfbf9] min-h-screen text-[#472825]">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-black bg-gradient-to-r from-amber-500 to-amber-700 bg-clip-text text-transparent">
            Compras
          </h1>
          <p className="text-sm text-zinc-500 mt-1">
            Gestión de ingreso de mercancía 18k
          </p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <button
            className="flex items-center gap-2 bg-zinc-50 text-zinc-700 border border-zinc-200 px-4 py-2.5 rounded-xl hover:bg-zinc-100 transition-colors font-medium"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <select className="w-full px-3 py-2 bg-zinc-50 border border-zinc-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 text-sm transition-all text-[#472825]">
              ...
              <option value="FC2">FC2 - FACTURA DE COMPRA 2</option>
          ...
          <table className="w-full text-left text-sm whitespace-nowrap">
            <thead className="bg-zinc-50 border-b border-zinc-100 text-zinc-600 font-semibold text-xs uppercase tracking-wider">
              <tr>
                ...
                <th className="px-4 py-3">CruceTipo</th>
                <th className="px-4 py-3">CruceNumero</th>
            ...
            <tbody className="divide-y divide-zinc-50">
              {mockData.map((item) => (
                <tr key={item.id} className="hover:bg-zinc-50 transition-colors text-zinc-700">
                  ...
                  <td className="px-4 py-2">{item.cruceTipo}</td>
                  <td className="px-4 py-2 font-mono">{item.cruceNumero}</td>
                  ...
                  <td className="px-4 py-2 text-right">${item.retenciones.toLocaleString()}</td>
          ...
          >
            ...
            >
              <div className="p-5 border-b border-zinc-100 flex justify-between items-center bg-[#fdfbf9]">
                <h2 className="text-lg font-bold text-[#472825]">Nueva Compra</h2>
                <button
            ...
            >
              <div className="p-5 border-b border-zinc-100 flex justify-between items-center bg-[#fdfbf9]">
                <h2 className="text-xl font-bold text-[#472825] flex items-center gap-2">
                  ...
                  Registro de Compra - Mercancía 18k
                </h2>
                <button
              ...
              <div className="p-6 overflow-y-auto flex-1 bg-zinc-50/50">
                ...
                <div className="bg-white p-5 rounded-xl border border-zinc-100 shadow-sm">
                  ...
                  <textarea
                    rows={6}
                    placeholder="Detalle los productos de joyería 18k ingresados..."
