...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fdfbf9] text-[#472825] flex items-center justify-center p-4 relative">
      <Link
        href="/"
      ...
      <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg border border-[#fdfbf9]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-2">
            <button
              type="submit"
              className="w-full bg-[#D3AB80] text-white py-2.5 rounded-md font-medium hover:bg-[#c2986f] transition-colors"
            >
              Iniciar Sesión
            </button>
          </div>
          ...
          <div className="text-center mt-4">
            <button
              ...
              className="text-sm text-[#472825] hover:underline"
            >
